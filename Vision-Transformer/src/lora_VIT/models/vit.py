...
def vit_b32_dlrt(r=16, adapter_name="dlrt", n_classes=10):
    ...
    elif adapter_name == "psi":
        from src.lora_VIT.lora_psi.config import AdaLoraConfig  # Same as DLRT
        from src.lora_VIT.lora_psi.model import AdaLoraModel  # Same as DLRT
        from src.lora_VIT.lora_psi.layer import AdaLoraLayer  # Changed!
        from src.lora_VIT.lora_psi.extract_weights import collect_lr_layers
